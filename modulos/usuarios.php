...
$sql = $conexion->query("SELECT * FROM usuarios_personas");
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td><?php echo $render->id ?></td>
                      <td><?php echo $render->correo ?></td>
                      <td><?php echo $render->contra ?></td>
                      <td><a href="eliminarUsuario.php?eliminar=<?php echo $render->id ?>">Eliminar</a> | <a href="editarUsuario.php?editar=<?php echo $render->id ?>">Editar</a></td>
                    </tr>
                    <?php } ?>
                  </tbody>
                </table>
